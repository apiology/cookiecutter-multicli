...
description: >-
  Sync boilerplate for this cookiecutter template (cookiecutter-chrome-extension,
  Chrome Extension) from reference repos using only origin/main;
...
- Port from reference repos only what fits **this** tier (Chrome Extension).
...
|------|--------------|--------|
| Meta | `cookiecutter-cookiecutter` | Bakes child templates; sync docs live under baked `cookiecutter-chrome-extension/` |
| Language/tool | `cookiecutter-ruby` | Chrome Extension boilerplate |
...
- Cookiecutter vars: `cookiecutter-chrome-extension`, `Chrome Extension`
