...
See [docs/SYNCING_BOILERPLATE.md](docs/SYNCING_BOILERPLATE.md). Interpret hierarchy at **this** tier (`cookiecutter-multicli`, Multi-CLI) using `.cursor/rules/template-hierarchy.mdc` when present.
